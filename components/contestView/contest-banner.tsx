        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center w-full">
            <div className="col-span-6 space-y-3">
                <div className="flex items-center space-x-2 text-muted-foreground text-sm">
                    ...
                    <span>{contest?.registers?.length ?? 0} Competitors</span>
                </div>
                ...
                <h1 className="text-4xl font-extrabold text-foreground">
                    {contest.name || <Skeleton className="h-8 w-2/3" />}
                </h1>

                <div className="text-muted-foreground text-base">
                    {contest.description || <Skeleton className="h-4 w-2/3" />}
                </div>

                <div className="flex flex-wrap items-center gap-4">
                    <Button className="bg-[#00d590] text-black hover:bg-[#00c485]">Action Button</Button>
                    <Button variant="outline"><CalendarIcon className="mr-2 h-4 w-4" />Add to Calendar</Button>
                </div>
